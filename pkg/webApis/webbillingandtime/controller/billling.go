...
func (e billing) registerRoutes() {
	http.HandleFunc("/billing", e.handleEntry)
}
func (e billing) handleEntry(w http.ResponseWriter, r *http.Request) {
